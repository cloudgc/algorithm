 ...
 *
 * @author cloudgc
 * @since 0.0.1 当需要构建一个复杂对象的时候，通常由子部分完成， 当复杂对象变化的时候，组合算法相对固定
 */
public class BuilderPatten {
    ...
    abstract static class AbstractCar implements Car {
        ...
        public String getConfigList() {
            return "Car Config: bracket(" + carBracket().getBracketType() + "), " + "engine(" + carEngine()
                    .getEngineType() + "), " + "gearbox(" + carGearBox().getGearBoxType() + ")....";
        }
    }
    ...
    public static void main(String[] args) {
        ...
        carBuilder.bracket(new SUVBracket()).engine(new ElectEngine()).gearBox(new AutoGearBox());
