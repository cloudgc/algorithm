...
public class BridgePattern {
    ...
    static class FlowStuctrue implements Structrue {
    ...
    static class BaseStructrue implements Structrue {
    ...
    static class TubineEngine implements Engine {
    ...
    static class InHaleEngine implements Engine {
    ...
    static class FullCar implements Car {
        ...
        @Override
        public void driver() {
            System.out.println("I drive car, with:" + structrue.getStructrue() + " on:" + engine.getEngine());
        }
    }
